...
void Engine_Ext_LorentzMaterial::DoPreVoltageUpdatesImpl(Engine* eng)
{
	for (int o=0;o<m_Order;++o)
	{
		...
		if (m_Op_Ext_Lor->m_volt_Lor_ADE_On[o])
		{
			for (unsigned int i=0; i<m_Op_Ext_Lor->m_LM_Count.at(o); ++i)
			{
				...
				volt_ADE[o][0][i] += m_Op_Ext_Lor->v_ext_ADE[o][0][i] * (eng->Engine::GetVolt(0,pos[0][i],pos[1][i],pos[2][i])-volt_Lor_ADE[o][0][i]);

				volt_Lor_ADE[o][1][i]+=m_Op_Ext_Lor->v_Lor_ADE[o][1][i]*volt_ADE[o][1][i];
				volt_ADE[o][1][i] *= m_Op_Ext_Lor->v_int_ADE[o][1][i];
				volt_ADE[o][1][i] += m_Op_Ext_Lor->v_ext_ADE[o][1][i] * (eng->Engine::GetVolt(1,pos[0][i],pos[1][i],pos[2][i])-volt_Lor_ADE[o][1][i]);

				volt_Lor_ADE[o][2][i]+=m_Op_Ext_Lor->v_Lor_ADE[o][2][i]*volt_ADE[o][2][i];
				volt_ADE[o][2][i] *= m_Op_Ext_Lor->v_int_ADE[o][2][i];
				volt_ADE[o][2][i] += m_Op_Ext_Lor->v_ext_ADE[o][2][i] * (eng->Engine::GetVolt(2,pos[0][i],pos[1][i],pos[2][i])-volt_Lor_ADE[o][2][i]);
			}
		}
		else
		{
			...
			{
				volt_ADE[o][0][i] *= m_Op_Ext_Lor->v_int_ADE[o][0][i];
				volt_ADE[o][0][i] += m_Op_Ext_Lor->v_ext_ADE[o][0][i] * eng->Engine::GetVolt(0,pos[0][i],pos[1][i],pos[2][i]);

				volt_ADE[o][1][i] *= m_Op_Ext_Lor->v_int_ADE[o][1][i];
				volt_ADE[o][1][i] += m_Op_Ext_Lor->v_ext_ADE[o][1][i] * eng->Engine::GetVolt(1,pos[0][i],pos[1][i],pos[2][i]);

				volt_ADE[o][2][i] *= m_Op_Ext_Lor->v_int_ADE[o][2][i];
				volt_ADE[o][2][i] += m_Op_Ext_Lor->v_ext_ADE[o][2][i] * eng->Engine::GetVolt(2,pos[0][i],pos[1][i],pos[2][i]);
			}
		}
	}
}
...
template <typename Engine>
void Engine_Ext_LorentzMaterial::DoPreCurrentUpdatesImpl(Engine* eng)
{
	for (int o=0;o<m_Order;++o)
	{
		...
		if (m_Op_Ext_Lor->m_curr_Lor_ADE_On[o])
		{
			for (unsigned int i=0; i<m_Op_Ext_Lor->m_LM_Count.at(o); ++i)
			{
				...
				curr_ADE[o][0][i] += m_Op_Ext_Lor->i_ext_ADE[o][0][i] * (eng->Engine::GetCurr(0,pos[0][i],pos[1][i],pos[2][i])-curr_Lor_ADE[o][0][i]);

				curr_Lor_ADE[o][1][i]+=m_Op_Ext_Lor->i_Lor_ADE[o][1][i]*curr_ADE[o][1][i];
				curr_ADE[o][1][i] *= m_Op_Ext_Lor->i_int_ADE[o][1][i];
				curr_ADE[o][1][i] += m_Op_Ext_Lor->i_ext_ADE[o][1][i] * (eng->Engine::GetCurr(1,pos[0][i],pos[1][i],pos[2][i])-curr_Lor_ADE[o][1][i]);

				curr_Lor_ADE[o][2][i]+=m_Op_Ext_Lor->i_Lor_ADE[o][2][i]*curr_ADE[o][2][i];
				curr_ADE[o][2][i] *= m_Op_Ext_Lor->i_int_ADE[o][2][i];
				curr_ADE[o][2][i] += m_Op_Ext_Lor->i_ext_ADE[o][2][i] * (eng->Engine::GetCurr(2,pos[0][i],pos[1][i],pos[2][i])-curr_Lor_ADE[o][2][i]);
			}
		}
		else
		{
			...
			{
				curr_ADE[o][0][i] *= m_Op_Ext_Lor->i_int_ADE[o][0][i];
				curr_ADE[o][0][i] += m_Op_Ext_Lor->i_ext_ADE[o][0][i] * eng->Engine::GetCurr(0,pos[0][i],pos[1][i],pos[2][i]);

				curr_ADE[o][1][i] *= m_Op_Ext_Lor->i_int_ADE[o][1][i];
				curr_ADE[o][1][i] += m_Op_Ext_Lor->i_ext_ADE[o][1][i] * eng->Engine::GetCurr(1,pos[0][i],pos[1][i],pos[2][i]);

				curr_ADE[o][2][i] *= m_Op_Ext_Lor->i_int_ADE[o][2][i];
				curr_ADE[o][2][i] += m_Op_Ext_Lor->i_ext_ADE[o][2][i] * eng->Engine::GetCurr(2,pos[0][i],pos[1][i],pos[2][i]);
			}
		}
	}
}
