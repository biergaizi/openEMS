...
protected:
	...
	Array2D_float* m_Mur_Coeff_nyP_ptr;
	Array2D_float* m_Mur_Coeff_nyPP_ptr;
	Array2D_float* m_volt_nyP_ptr; //n+1 direction
	Array2D_float* m_volt_nyPP_ptr; //n+2 direction
};
